  ...
  <div class="app-container">
    ...
    <div class="header">
      <el-form :inline="true" :model="formInline" class="demo-form-inline" ref="form">
        ...
        <!--        <el-form-item>-->
        <!--          &lt;!&ndash;      ref=form设置在表单开头el-form，方法内：this.$refs.form.resetFields(),要重置的加prop&ndash;&gt;-->
    ...
    <!--            &lt;!&ndash;            <el-option label="PaymentStatus" value="PaymentStatus.value" />&ndash;&gt;-->
    ...
    <!--        &lt;!&ndash;          <el-input v-model="form.remarks" autocomplete="off" type="textarea"></el-input>&ndash;&gt;-->
